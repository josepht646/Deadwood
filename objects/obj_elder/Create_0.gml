...
ds_list_add(storyLines, "Now that you have both keys, you can enter the tomb and defeat the sorcerer. If I am correct, this will reverse the curse and allow our world to slowly heal. This will be a difficult fight, so ensure that you are ready before departing. We are all counting on you.");
ds_list_add(storyLines, "Now that you have both keys, you can enter the tomb and defeat the sorcerer. We are all counting on you.");
